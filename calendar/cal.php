...
$start_year=2010; // Starting year for dropdown list box
...
self.location='http://localhost/yoga_site/<?php echo $location?>?month=' + month_val + '&year=' + year_val ; // reload the page
//window.location="http://localhost/yoga_site?month=" + month_val + '&year=' + year_val ;
}
</script>
<style type="text/css">
table.main {
...
echo "<table class='main'><td colspan=7 ><center>
...
echo "<tr><td colspan=7 align=center><b>Events of this month</b></a></td></tr>"; 
echo "</tr></table>";
